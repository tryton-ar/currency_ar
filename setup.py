#!/usr/bin/env python3
# This file is part of the currency_ar module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton module for Argentinian currency exchange rate',
    ...
    keywords='tryton currency rate argentina',
